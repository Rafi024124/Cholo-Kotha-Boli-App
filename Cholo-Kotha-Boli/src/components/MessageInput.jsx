...
const MessageInput = () => {
  ...
  <div className="flex-1 flex gap-2 items-center">
    <input
      type="text"
      className="flex-1 rounded-lg input input-bordered input-sm sm:input-md bg-white text-cyan-900 placeholder-cyan-600 border-cyan-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400"
    ...
    <button
      type="button"
      className="flex btn btn-circle btn-sm text-cyan-400 hover:text-cyan-600 transition-colors"
